...
xlabel('\omega')
ylabel('$M_1^* M_2 + M_2 M_1^*$', 'interpreter', 'latex')
...
hgsave(fack, ['psd_var', suffix,'.fig'])
saveas(fack, ['psd_var', suffix,'.png'])
...
if normalize_xcorr
    ...
    save(['var_psd_data', suffix,'.mat'], 'covar_T', 'weights', 'Ts', 'omega')
end
